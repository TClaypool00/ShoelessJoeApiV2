...
namespace ShoelessJoeWebApi.DataAccess.Migrations
{
    ...
    [Migration("20210313181955_AddedModelManufacter")]
    partial class AddedModelManufacter
    {
            ...
            modelBuilder.Entity("ShoelessJoeWebApi.DataAccess.DataModels.ShoeImage", b =>
                {
                    ...
                    b.Property<string>("LeftShoeDown")
                        ...
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasDefaultValueSql("/Shoes/generic-shoe.png");
                    ...
                    b.Property<string>("RightShoeRight")
                        ...
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasDefaultValue("/Shoes/generic-shoe.png");
            ...
            modelBuilder.Entity("ShoelessJoeWebApi.DataAccess.DataModels.Manufacter", b =>
                {
                    b.HasOne("ShoelessJoeWebApi.DataAccess.DataModels.Model", "Model")
                        .WithOne("Manufacter")
                        .HasForeignKey("ShoelessJoeWebApi.DataAccess.DataModels.Manufacter", "ModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
